...
class TestIngestHandwritingBasic:
    ...
    def test_ingest_with_deduplication(self, tmp_image_dir):
        ...
        with (
            ...
            assert (
                result.pages_ingested == 5 - result.skipped_already_ingested - result.skipped_blank
            )
    ...
    def test_ingest_with_low_confidence_warning(self, tmp_image_dir):
        ...
        with (
            ...
            mock_correct.return_value = (
                "completely different corrected text that bears no resemblance"
            )
    ...
    def test_ingest_folder_grouping(self, tmp_image_dir):
        ...
        with (
            ...
            expected_prefixes = {
                "handwriting:test_collection:2024/notes",
